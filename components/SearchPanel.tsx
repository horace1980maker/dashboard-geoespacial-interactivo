...
export const SearchPanel: React.FC<SearchPanelProps> = ({ result, error, isLoading, onClose }) => {
    ...
    return (
        <div className="absolute top-4 right-4 w-96 max-h-[calc(100%-2rem)] bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden animate-slide-in-right flex flex-col">
